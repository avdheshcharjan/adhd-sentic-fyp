...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}p{2.8cm}p{3.2cm}p{4.5cm}l@{}}
    ...
    Obj 4: Screen + JITAI & Real-time classification & 549 titles/s, 78\% rule coverage & Exceeded \\[4pt]
